...
import '../viewmodels/elderly_reminder_create_viewmodel.dart';
import '../models/reminder_model.dart';

class ElderlyReminderCreateView extends StatelessWidget {
  const ElderlyReminderCreateView({super.key});

  @override
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (_) => ElderlyReminderCreateViewModel(),
      child: const ElderlyReminderCreateContent(),
    );
  }
}

class ElderlyReminderCreateContent extends StatelessWidget {
  const ElderlyReminderCreateContent({super.key});
  ...
  @override
  Widget build(BuildContext context) {
    final viewModel = context.watch<ElderlyReminderCreateViewModel>();
                        ...
                        children: [
                          ...
                          GestureDetector(
                            onTap: () {
                              ...
                              // Will integrate with camera plugin and OCR service
                        ...
                        Container(
                          ...
                          child: Row(
                            children: [
                              ...
                              Expanded(
                                child: Text(
                                  'Only caregivers can attach voice notes. Elderly can play voice notes if provided.',
                                  style: TextStyle(
                                    fontSize: 13,
  ...
  Widget _buildDateTimePicker(BuildContext context,
      ElderlyReminderCreateViewModel viewModel, Color color) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        const Row(
  ...
  Future<void> _selectDateTime(
      BuildContext context, ElderlyReminderCreateViewModel viewModel) async {
