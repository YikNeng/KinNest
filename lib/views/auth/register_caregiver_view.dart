// lib/views/auth/register_caregiver_view.dart

import 'package:flutter/material.dart';
import 'package:provider/provider.dart';
import 'package:go_router/go_router.dart';
import '../../viewmodels/auth/register_caregiver_viewmodel.dart';

class RegisterCaregiverView extends StatelessWidget {
  const RegisterCaregiverView({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (_) => RegisterCaregiverViewModel(),
      child: const RegisterCaregiverContent(),
    );
  }
}

class RegisterCaregiverContent extends StatelessWidget {
  const RegisterCaregiverContent({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final viewModel = context.watch<RegisterCaregiverViewModel>();
  ...
  Future<void> _handleRegister(
    ...
    RegisterCaregiverViewModel viewModel,
  ) async {
